### https://github.com/winstxnhdw/FullStanleyController/tree/master
...
# geometry_msgs.msg.PoseStamped(header=std_msgs.msg.Header(seq=m.header.seq,stamp=m.header.stamp,frame_id="my_new_frame"),pose=m.pose)



class StanleyController:

    def __init__(self, control_gain=2.5, softening_gain=1.0, yaw_rate_gain=0.0, steering_damp_gain=0.0, max_steer=np.deg2rad(180), wheelbase=0.0, path_x=None, path_y=None, path_yaw=None):
